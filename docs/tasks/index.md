...
| `0027-reconciliation-and-health.md` | `P1-06`         | Reconciliation and volume health       | Active     | #57   | pending      | Health gates every conclusion; the trash is reported rather than indexed, and retention is opt-in. |
