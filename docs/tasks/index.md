...
| `0019-folder-creation.md`        | `P1-19`    | Folder creation API                    | Active     | #42   | —            | First write to disk; descriptor-relative, non-recursive, conflicts are `409`.              |
...
1. Finish `P1-19` folder creation, the domain's first write.
