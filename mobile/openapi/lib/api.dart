...
part 'model/file_copy_dto.dart';
part 'model/file_entry_response_dto.dart';
part 'model/file_entry_type.dart';
part 'model/file_folder_create_dto.dart';
part 'model/file_move_dto.dart';
part 'model/file_reconcile_dto.dart';
part 'model/file_reconcile_response_dto.dart';
part 'model/file_trash_empty_dto.dart';
part 'model/file_trash_purge_response_dto.dart';
part 'model/file_trash_record_response_dto.dart';
part 'model/file_trash_report_dto.dart';
part 'model/file_trash_restore_dto.dart';
part 'model/file_volume_access.dart';
part 'model/file_volume_health_reason.dart';
part 'model/file_volume_health_response_dto.dart';
part 'model/file_volume_kind.dart';
part 'model/file_volume_member_access.dart';
part 'model/file_volume_member_add_dto.dart';
part 'model/file_volume_member_response_dto.dart';
part 'model/file_volume_response_dto.dart';
part 'model/file_volume_state.dart';
